#!/usr/bin/env python3
# Copied from https://github.com/jupyter/docker-stacks/tree/abea5caf78da2dbe1af0ded0b1e184191016ba57/images/minimal-notebook/setup-scripts, adapted to download a specific Julia version
...
def get_julia_version_url(version: str) -> tuple[str, str]:
    """
    ...
    latest_version_files = stable_versions[version]["files"]
...
def configure_julia(julia_version: str) -> None:
    ...
    # Tell Julia where conda libraries are and default startup folder
...
if __name__ == "__main__":
    ...
    parser.add_argument('version',
                        type=str,
                        help="Julia version to install)")
    args = parser.parse_args()

    julia_url, julia_version = get_julia_version_url(args.version)
