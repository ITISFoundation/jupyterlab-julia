#!/bin/bash
# Copied and adapted from: https://github.com/jupyter/docker-stacks/blob/abea5caf78da2dbe1af0ded0b1e184191016ba57/images/minimal-notebook/setup-scripts/setup-julia-packages.bash
